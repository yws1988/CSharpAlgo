/*
    ...
    “x = 1, y = 2”, “x = 5, y = 0” and “x = 1. It may be assumed that all coefficients 
    in given equation are positive integers.
...
namespace Maths
{
    public class NumberOfEquationSolution
    {
        //Bottom-up
        public static int GetNumberOfSolutions(int[] coefficients, int sum)
        {
